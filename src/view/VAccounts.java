...
public class VAccounts extends javax.swing.JPanel {
    ...
    MAccounts model = new MAccounts();
    CAccounts controller = new CAccounts(model);
        ...
        incomeCategoryTable1.addMouseListener(new java.awt.event.MouseAdapter() {
            ...
            public void mousePressed(java.awt.event.MouseEvent evt) {
                ...
                if (row >= 0 && col == 3) {
                    ...
                    txtHeading.setText("Edit Account : " + id);
                    ...
                    int option = JOptionPane.showConfirmDialog(VAccounts.this,
                            "Are you sure you want to delete " + (String) incomeCategoryTable1.getValueAt(row, 1) + " Account?",
                            "Delete Confirmation",
    ...
    private void initComponents() {
        ...
        txtHeading1.setText("Account List");
    ...
    private void btnAddMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnAddMouseClicked
        ...
        if (catName == null || categoryColor == null || catName.equals("")) {
            MessageBox validateShow = new MessageBox((java.awt.Frame) parentWindow,
                    ...
                    "<html>Please make sure both Account Name<br> and Color are entered to proceed with<br>accounts creation</html>",
                    "Back",
                    Color.YELLOW);
